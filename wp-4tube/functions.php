...
function wpeHeadNav()
{
    ...
    array(
        ...
        'link_before'     => '',
        'link_after'      => '',
        'items_wrap'      => '<ul class="categories-nav sh">%3$s</ul>',
        'depth'           => 0,
        'walker'          => ''
        )
    );
...
function wpeABCNav()
{
	...
	array(
		...
		'link_before'     => '',
		'link_after'      => '',
		'items_wrap'      => '<ul class="order-alpha sh additional-margin">%3$s</ul>',
		'depth'           => 0,
		'walker'          => ''
		)
	);
...
function register_html5_menu() {
    register_nav_menus(array( 
        'header-menu' => __('Head dropdown cat menu', 'wpeasy'),   
        'abc-menu' => __('abc menu', 'wpeasy'),   
        'sidebar-menu' => __('Меню в сайдбар', 'wpeasy'), 
        'footer-menu' => __('footer menu', 'wpeasy') 
    ));
}
